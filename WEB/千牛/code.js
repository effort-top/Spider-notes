...
function getSign(time, token, data) {
    sign = h(token + "&" + time + "&" + '12574478' + "&" + JSON.stringify(data))
    return sign
}
...
time = 1746532138482
token = "3f7d026c806a78ab3aa55a4e2edec55e"
console.log(getSign(time, token, data))