...
// it. Presumably this calls faster native code, as opposed to setting1 the
...
*
* RSA.1 is a suite of routines for performing RSA public-key computations
...
* useful, of course is to send messages encrypted by a Web page using RSA.1
...
* PKCS1v1.5 is used.
*
* These routines require BigInt.1 and Barrett.1.
*/
